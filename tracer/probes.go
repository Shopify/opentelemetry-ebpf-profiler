...
var dynamicProbeResources = struct {
	...
	maps: []string{
		...
		"io_uring_requests",
		"io_uring_correlations",
		"io_uring_request_aliases",
		"tcp_connect_starts",
		"tcp_ack_send_calls",
		"tcp_ack_track_calls",
	...
	programs: []string{
		...
		"io_uring_issue",
		"io_uring_complete",
		"tcp_connect_v4_start",
		"tcp_connect_v6_start",
		"tcp_connect_state",
		"tcp_ack_send_entry",
		"tcp_ack_send_exit",
		"tcp_ack_track_entry",
	...
	variables: []string{
		"block_io_origin",
		"block_io_mode",
		"block_io_old_rq_args",
		"block_io_min_ns",
		"block_io_sample_threshold",
		"block_io_has_btf_layout",
		"block_io_has_direct_disk",
		"block_io_request_bio_offset",
		"block_io_request_flags_offset",
		"block_io_request_bytes_offset",
		"block_io_request_queue_offset",
		"block_io_request_disk_offset",
		"block_io_queue_disk_offset",
		"block_io_disk_major_offset",
		"block_io_disk_minor_offset",
		"block_io_bio_flags_offset",
		"function_latency_min_ns",
		"function_latency_origin",
		"function_latency_sample_threshold",
		"io_uring_origin",
		"io_uring_min_ns",
		"io_uring_sample_threshold",
		"io_uring_submit_has_req",
		"io_uring_submit_ctx_offset",
		"io_uring_submit_req_offset",
		"io_uring_submit_user_data_offset",
		"io_uring_submit_opcode_offset",
		"io_uring_submit_sq_thread_offset",
		"io_uring_complete_has_req",
		"io_uring_complete_has_flags",
		"io_uring_complete_ctx_offset",
		"io_uring_complete_req_offset",
		"io_uring_complete_user_data_offset",
		"io_uring_complete_result_offset",
		"io_uring_complete_result_size",
		"io_uring_complete_flags_offset",
		"tcp_connect_origin",
		"tcp_connect_min_ns",
		"tcp_connect_sample_threshold",
		"tcp_connect_has_sk_err",
		"tcp_connect_sk_err_offset",
		"tcp_ack_origin",
		"tcp_ack_min_ns",
		"tcp_ack_sample_threshold",
		"tcp_ack_has_layout",
		"tcp_ack_write_seq_offset",
		"tcp_ack_snd_una_offset",
		"tcp_receive_origin",
		"tcp_receive_min_ns",
		"tcp_receive_sample_threshold",
		"tcp_receive_has_layout",
		"tcp_receive_copied_seq_offset",

...
var MetricsTranslation = []metrics.MetricID{
	...
	C.metricID_UnwindNativeCustomLabelsErrReadValue:       metrics.IDUnwindNativeCustomLabelsErrReadValue,
	C.metricID_UnwindNativeCustomLabelsReadSuccesses:      metrics.IDUnwindNativeCustomLabelsReadSuccesses,
	C.metricID_UnwindNativeCustomLabelsAddErrors:          metrics.IDUnwindNativeCustomLabelsAddErrors,
	C.metricID_UnwindNativeCustomLabelsAddSuccesses:       metrics.IDUnwindNativeCustomLabelsAddSuccesses,

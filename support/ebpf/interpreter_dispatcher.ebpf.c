...
// native_custom_labels.h depends on identifiers from the headers above
// (EBPF_INLINE, BPF helpers, types, metricIDs, MIN, cl_procs / v8_procs
// extern decls from extmaps.h via tracemgmt.h).
#include "native_custom_labels.h"

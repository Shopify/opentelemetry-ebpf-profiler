...
func TestOffCPUTimeBPFMetricsLayout(t *testing.T) {
	var value offCPUTimeBPFMetrics
	require.Equal(t, uintptr(0), unsafe.Offsetof(value.SwitchOuts))
	require.Equal(t, uintptr(8), unsafe.Offsetof(value.SwitchIns))
	require.Equal(t, uintptr(16), unsafe.Offsetof(value.UnmatchedSwitchIns))
	require.Equal(t, uintptr(24), unsafe.Offsetof(value.Filtered))
	require.Equal(t, uintptr(32), unsafe.Offsetof(value.Emitted))
	require.Equal(t, uintptr(40), unsafe.Offsetof(value.StateUpdateFailures))
	require.Equal(t, uintptr(48), unsafe.Sizeof(value))
}
